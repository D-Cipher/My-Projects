...
class ProfileTabController: UITableViewController {
    ...
    func updateUserProfilePic() {
        ...
        ////=======>>>>just have app upload to phone's storage
        ...
        if NSUserDefaults().objectForKey("userProfileImages") != nil {
            ...
            if self.userProfileImages["image_1"] != nil {
                self.profileImageOutlet.image = UIImage(data: (self.userProfileImages["image_1"] as? NSData)!)
            }
        } else {
            self.profileImageOutlet.image = UIImage(named: "placeholder-camera-green.png")
    ...
    override func tableView(tableView: UITableView, willSelectRowAtIndexPath indexPath: NSIndexPath) -> NSIndexPath? {
        ...
        if indexPath.section == 0 && indexPath.row == 0 {
            ...
            performSegueWithIdentifier("FollowersSegue", sender: self)
