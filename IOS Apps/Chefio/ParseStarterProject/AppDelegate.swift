...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let col_tealblue = UIColor(red: 102/255, green: 181/255, blue: 185/255, alpha: 1.0)
        
        //App Skin Customization
        UINavigationBar.appearance().barTintColor = col_tealblue
        ...
        UITabBar.appearance().tintColor = col_tealblue
        ...
        Parse.setApplicationId("yQ3636APnrwC11wV8JfAmKa8Ff6e8tXMwQ9q9NIM",
                               clientKey: "BXQpYLINSLvVpBHrnk6oxhdXiUhjIfqjsXCV7w4p")
