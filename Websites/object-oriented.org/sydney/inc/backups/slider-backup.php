...
function sydney_slider_template() {
    ...
    $speed      = get_theme_mod('slider_speed', '10000');
    $text_slide = get_theme_mod('textslider_slide', 0);

    //Slider text
    if ( !function_exists('pll_register_string') ) {
        $slider_title_1     = get_theme_mod('slider_title_1', 'Welcome to Object-Oriented');
        ...
        $slider_title_1     = pll__(get_theme_mod('slider_title_1', 'Welcome to Object-Oriented'));
