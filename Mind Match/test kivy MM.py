...
class Game(Widget):
    ...
    def __init__(self):
        ...
        self.card1 = Card(0, 3, (17, 100), select = False, eliminate = False)
        self.card2 = Card(8, 1, (112, 100), select = False, eliminate = False)
        self.card3 = Card(16, 2, (205, 100), select = False, eliminate = False)
        self.card4 = Card(1, 1, (17, 200-5), select = False, eliminate = False, secret_card = True)
        self.card5 = Card(8, 2, (112, 200-5), select = False, eliminate = False)
        self.card6 = Card(6, 1, (205, 200-5), select = False, eliminate = False)
        self.card7 = Card(5, 3, (17, 300-10), select = False, eliminate = False)
        self.card8 = Card(9, 2, (112, 300-10), select = False, eliminate = False)
        self.card9 = Card(16, 1, (205, 300-10), select = False, eliminate = False)
